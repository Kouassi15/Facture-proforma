...
<body class="bg-image">
    <div>
        <div class="header__section">
            ...
            <div>
                ...
                <div >
                    <p style="float: right;margin-top: -95px">Date : {{ $facture->date }}</p>
                </div>
            </div>
  ...
  <br/><br/>
    ...
    <div class="footer">
        <hr />
	  <span style="font-size:10px"> DOMICILIATION BANCAIRE : BIAO-CI-N° DE COMPTE0223 50252530 / TRESOR N° de compte : A 6500 01001 10267530008 / BNI AGENCE 2 PLATEAUX N° compte:003205010056</span> <br/>
        <!-- <span>Location et vente de véhicules / Rénovation bâtiment / Gestion immobilière / Décoration intérieure / Assurances </span> <br/> -->
        <span style="font-size:10px">Siège : II Plateaux- Tél.+225 22415280-Cél+225 07522642 / 07-07-92-31-92 /01 BP2568 Abidjan / E-mail : <a href="mailto:guma1@aviso.ci">guma1@aviso.ci</a></span>
    </div>
</body>
@endif
...
<body class="bg-image">
        ...
        <div style="margin-top: 5px;">
            <table class="table table-striped table-hover" style="border: none">
                ...
                <tbody>
				   ...
				   <tr>
					 <td style=" margin-bottom: 10px; font-weight: bold" colspan="5">Arrêtée la presente Facture Proforma à la Somme de:</td>
                        <td style="color: rgb(190, 7, 40); vertical-align: middle; font-weight: bold">{{ $facture->montant_lettre}}</td>
                    </tr>
                </tbody>
            </table>
            <br /><br />
  ...
  <div class="footer">
        <hr />
       <span style="font-size: 10px; margin: auto;"> Domiciliation Bancaire : BNI ANGENCE 2 Plateaux N° compte CI 09201008 003205010004 31/ BANQUE DU TRESOR N°compte : CI 650 01001 010282040009 68</span> <br/>
        <span style="font-size: 10px">Siège : II Plateaux - Cél+225 07522642 / 0707923192 - 01 BP2568 Abidjan 01 / E-mail : <a href="mailto:guma1@aviso.ci">guma1@aviso.ci</a>cc : 8801972C-RC7320 Imposition:Réel Simplifié - Centre Adjame</span>
    </div>
</body>
@endif
